...
architecture divisor of gen_reloj is
    ...
    signal limite      : integer := 50000000; ---ciclos necesarios para medio periodo
...
begin
    ...
    limite <= 50000000 when modo_freq = "00" else  ---frecuencia 1 hz
              25000000 when modo_freq = "01" else  ---frecuencia 2 hz
              12500000 when modo_freq = "10" else  ---frecuencia 4 hz
              6250000;                             ---frecuencia 8 hz
